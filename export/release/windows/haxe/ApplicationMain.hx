...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("X02Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("X02Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "mateusx02";
		app.meta["file"] = "X02Engine";
		app.meta["name"] = "X02Engine";
		app.meta["packageName"] = "com.mateusx02.x02engine";
		app.meta["version"] = "1.0";
