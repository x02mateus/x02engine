...
class MusicManager {
    ...
    */
    public static function getSongName():Array<String> {
        ...
        switch(curPlaying) {
            case "1": return ["aquatic ambiance", "scizzie"];
            case "2": return ["LEASE", "Takeshi Abo"];
            case "3": return ["Relaxed Scene", "James Clarke"];
            case "4": return ["WINDOWS 95", 'Che Mac'];
            case "5": return ["Lotus Waters", 'Yume 2ikki'];
            case "6": return ["SR20DET", "BLKSMIITH"];
            case "7": return ["Virtual Tears", "TOKYOPILL"];
        }
        return [null, null];
    }
